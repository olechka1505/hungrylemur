	...
	<div id="content-box">
		<div id="post-body">
			<div <?php post_class('post-single'); ?>>
				...
				<!--<?php //echo do_shortcode("[KGVID poster='<?php echo get_post_meta( get_the_ID(), 'wpcf-video-cover-image', true ); ?>' fullwidth='true' caption='Cleaning the wrench' endofvideooverlay='<?php //echo get_post_meta( get_the_ID(), 'wpcf-video-cover-image', true ); ?>']<?php //echo get_post_meta( get_the_ID(), 'wpcf-insert-link', true ); ?>[/KGVID]"); ?>-->
				</div>
