<?php
/**
 * Template Name: Page for shop
 *
 * @package DiRocco
 */
$modality_theme_options = modality_get_options( 'modality_theme_options' );
get_header(); ?>
	<div id="main" class="col1 main-cart">
	<?php
		// Start the Loop.
...
<div class="content-posts-wrap">
	<div id="content-box">
		<div id="post-body" class="post-body-cart">
			<div <?php post_class('post-single'); ?>>
				<h1 id="post-title" class="shopping-cart-title" <?php post_class('entry-title'); ?>><?php the_title(); ?> </h1>
				<?php 
