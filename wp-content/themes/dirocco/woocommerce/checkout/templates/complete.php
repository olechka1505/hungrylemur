<div class="col-xs-12">
    ...
    <div class="col-md-3 col-xs-12 pull-right">
        <div ng-if="completeData.shipping.standard" class="text-right"><strong>SHIPPING: FREE</strong></div>
        <div ng-if="completeData.shipping.expedited" class="text-right"><strong>SHIPPING: +$40</strong></div>
