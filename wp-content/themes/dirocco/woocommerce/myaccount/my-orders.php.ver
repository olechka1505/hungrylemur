...
if ( $customer_orders ) : ?>
	...
	<table class="shop_table shop_table_responsive my_account_orders myaccount-orders">
			...
			<tr class="order">
					<td class="order-number" data-title="<?php esc_attr_e( 'Order Number', 'woocommerce' ); ?>">
						<a href="<?php echo esc_url( $order->get_view_order_url() ); ?>">
							<?php echo _x( 'TN', 'hash before order number', 'woocommerce' ) . $order->get_order_number(); ?>
						</a>
					</td>
