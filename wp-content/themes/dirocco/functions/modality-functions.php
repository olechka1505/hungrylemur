...
wp_enqueue_style ('fullPage', get_template_directory_uri() . '/js/vendor/jquery.fullpage.css');	
	/** 
	 * Enqueue javascripts
	 */
	wp_enqueue_script('fullPage', get_template_directory_uri() . '/js/vendor/jquery.fullpage.js', array( 'jquery' ),'', false);
	wp_enqueue_script('toggle-menu', get_template_directory_uri() . '/js/custom/toggle-menu.js', array( 'jquery' ),'', false);
