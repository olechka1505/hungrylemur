<tr valign="top" id="service_options">
	...
	<strong><?php _e( 'Services', 'wf_fedEx_wooCommerce_shipping' ); ?></strong><br><br>
		<table class="fedex_services widefat">
			<thead>
				<th class="sort">&nbsp;</th>
				<th><?php _e( 'Service Code', 'wf_fedEx_wooCommerce_shipping' ); ?></th>
				<th><?php _e( 'Name', 'wf_fedEx_wooCommerce_shipping' ); ?></th>
				<th><?php _e( 'Enabled', 'wf_fedEx_wooCommerce_shipping' ); ?></th>
				<th><?php echo sprintf( __( 'Price Adjustment (%s)', 'wf_fedEx_wooCommerce_shipping' ), get_woocommerce_currency_symbol() ); ?></th>
				<th><?php _e( 'Price Adjustment (%)', 'wf_fedEx_wooCommerce_shipping' ); ?></th>
			</thead>
			<tbody>
				<?php
					$sort = 0;
