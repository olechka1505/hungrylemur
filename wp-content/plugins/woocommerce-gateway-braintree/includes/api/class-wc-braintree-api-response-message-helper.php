 ...
 */
class WC_Braintree_API_Response_Message_Helper extends SV_WC_Payment_Gateway_API_Response_Message_Helper {
	...
	public function __construct( $response ) {
		...
		parent::__construct( WC_Braintree::TEXT_DOMAIN );
	}
	...
	public function get_user_message( $message_id ) {
		...
		switch ( $message_id ) {
			...
			case 'paypal_closed':
				$message = __( 'Sorry, we cannot process your transaction. The PayPal account is either locked or closed. Please use a different account or a different payment method.', WC_Braintree::TEXT_DOMAIN );
				break;
