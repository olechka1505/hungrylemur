...
class WC_Braintree_Hosted_Fields_Payment_Form extends WC_Braintree_Payment_Form {
	...
	protected function get_payment_form_handler_js_params() {
		...
		return array(
			...
			'threeds'      => array(
				'enabled'                         => $this->get_gateway()->is_3d_secure_enabled(),
				'liability_shift_always_required' => $this->get_gateway()->is_3d_secure_liability_shift_always_required(),
				'failure_message'                 => __( 'We cannot process your order with the payment information that you provided. Please use an alternate payment method.', WC_Braintree::TEXT_DOMAIN ),
			),
