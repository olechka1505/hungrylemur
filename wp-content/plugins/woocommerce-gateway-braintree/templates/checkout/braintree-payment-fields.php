...
<?php if ( $has_cards ) : ?>
	<p class="form-row form-row-wide">
		<a class="button" style="float:right;" href="<?php echo esc_url( SV_WC_Plugin_Compatibility::wc_get_page_permalink( 'myaccount' ) ); ?>#braintree-my-saved-cards"><?php _e( 'Manage Saved Cards', WC_Braintree::TEXT_DOMAIN ); ?></a>
		...
		<?php endforeach; ?>
		<input type="radio" id="braintree-use-new-card" name="braintree-cc-token" <?php checked( $has_cards, false ); ?> style="width:auto;" value="" /> <label style="display:inline;" for="braintree-use-new-card"><?php echo __( 'Use a new credit card', WC_Braintree::TEXT_DOMAIN ); ?></label>
